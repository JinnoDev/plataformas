...
let AuthController = class AuthController {
    ...
    resetPassword(dto) { return this.authService.resetPassword(dto.email); }
    logout(user) { return { success: true, message: `Sesión cerrada para ${user.username}` }; }
};
...
__decorate([
    ...
    (0, common_1.HttpCode)(200),
    (0, swagger_1.ApiOperation)({ summary: 'Restablecer contraseña a 12345678' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
