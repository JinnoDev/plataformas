...
__decorate([
    (0, mongoose_1.Prop)({ enum: ['like', 'comment', 'follow', 'repost', 'mention'], required: true }),
...
exports.NotificationSchema.index({ userId: 1, actorId: 1, type: 1, postId: 1 }, { unique: true, sparse: true });
